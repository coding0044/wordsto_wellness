...
export default function PlanStatusBadge({ user }) {
  ...
  const planName =
    user?.planName || user?.plan?.name || user?.subscription?.plan || "Free";
        ...
        >
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <span
                className={`inline-flex items-center gap-1 px-3 py-1 ${statusBgColor} rounded-full`}
              >
                <span className={`w-2 h-2 rounded-full ${statusColor}`}></span>
                <p className={`text-sm font-light ${statusColor} capitalize`}>
                  {planStatus}
                </p>
              </span>
            </div>
            ...
            {resetFrequency && (
              <div>
                ...
                <p className="font-light text-gray-700 capitalize">
                  {resetFrequency}
                </p>
              </div>
            )}
