// styles/topics-styles.js

export const TOPICS_LAYOUT = {
...
export const TOPICS_BREADCRUMB = {
...
export const TOPICS_HEADER = {
  ...
  iconContainer: "w-14 h-14 rounded-xl bg-gradient-to-br from-violet-400 to-purple-500 flex items-center justify-center text-white text-2xl shadow-md",
  title: "text-3xl font-bold text-gray-900",
  subtitle: "text-gray-600",
};

export const TOPICS_SEARCH = {
  ...
  input: "block w-full pl-12 pr-5 py-3.5 text-base border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:border-violet-500 focus:ring-2 focus:ring-violet-200 transition-all duration-200 bg-white",
};

export const TOPICS_GRID = {
...
export const TOPICS_CARD = {
  link: "group block bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-md hover:border-violet-200 transition-all duration-200",
  headerContainer: "flex items-start justify-between mb-4",
  iconContainer: "w-14 h-14 rounded-xl bg-gradient-to-br from-violet-400 to-purple-500 flex items-center justify-center text-white text-2xl shadow-md group-hover:scale-105 transition-transform",
  badge: "px-2.5 py-1 bg-violet-50 text-violet-600 rounded-full text-xs font-semibold uppercase tracking-wide",
  title: "text-lg font-semibold text-gray-900 mb-3 group-hover:text-violet-600 transition-colors line-clamp-2",
  ...
  exploreLink: "flex items-center space-x-1 text-violet-600 font-semibold text-sm group-hover:translate-x-1 transition-transform",
};