// styles/browse-letters-styles.js

export const BROWSE_LETTERS_LAYOUT = {
...
export const BROWSE_LETTERS_LOADING = {
  content: "space-y-4",
...
export const BROWSE_LETTERS_NAVBAR = {
...
export const BROWSE_LETTERS_HEADER = {
  container: "mb-8",
  ...
  iconContainer: "w-14 h-14 rounded-xl bg-gradient-to-br from-sky-400 to-blue-500 flex items-center justify-center text-white text-2xl shadow-md",
  title: "text-3xl font-bold text-gray-900",
  subtitle: "text-gray-600",
};

export const BROWSE_LETTERS_SEARCH = {
  ...
  input: "block w-full pl-12 pr-5 py-3.5 text-base border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:border-sky-500 focus:ring-2 focus:ring-sky-200 transition-all duration-200 bg-white",
};

export const BROWSE_LETTERS_GRID = {
...
export const BROWSE_LETTERS_CATEGORY_CARD = {
  ...
  iconContainer: "w-14 h-14 rounded-xl bg-gradient-to-br from-sky-400 to-blue-500 flex items-center justify-center text-white text-2xl shadow-md group-hover:scale-105 transition-transform",
  badge: "px-2.5 py-1 bg-sky-50 text-sky-600 rounded-full text-xs font-semibold uppercase tracking-wide",
  title: "text-lg font-semibold text-gray-900 mb-3 group-hover:text-sky-600 transition-colors line-clamp-2",
  ...
  exploreLink: "flex items-center space-x-1 text-sky-600 font-semibold text-sm group-hover:translate-x-1 transition-transform",
};