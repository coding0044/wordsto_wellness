...
export default function AdminDashboard({ defaultTab = "categories" }) {
  ...
  const topics = useMemo(
    () => subcategories.flatMap((subcategory) => subcategory.topics || []),
    [subcategories],
  );
  const letters = useMemo(
    () => topics.flatMap((topic) => topic.letters || []),
    [topics],
  );
  ...
  const topicMap = useMemo(
    () => new Map(topics.map((t) => [String(t._id), t.name])),
    [topics],
  );
  ...
  const openForm = (type, item = null) => {
    ...
    if (item) {
      ...
      setFormData({
        ...
        slug: item.slug || "",
        category:
          item.category?._id || item.category?.id || item.category || "",
        subcategory:
    ...
    if (type === "user") {
      ...
      map[type]?.mutate(id, {
        onSuccess: () => {
          ...
          setPagination((prev) => ({
            ...prev,
            [type === "letter" ? "letters" : type + "s"]: {
              ...prev[type === "letter" ? "letters" : type + "s"],
              page: 1,
            },
          }));
        },
    ...
    if (formType === "user") {
        ...
        updateCategoryMutation.mutate(
          { id: editingItem._id, data: d },
          {
            onSuccess: () => {
              ...
              setPagination((prev) => ({
                ...prev,
                categories: { ...prev.categories, page: 1 },
              }));
            },
            onError: (error) =>
              showNotification(
        ...
        updateSubcategoryMutation.mutate(
          { id: editingItem._id, data: d },
          {
            onSuccess: () => {
              ...
              setPagination((prev) => ({
                ...prev,
                subcategories: { ...prev.subcategories, page: 1 },
              }));
            },
            onError: (error) =>
              showNotification(
      ...
      if (editingItem) {
        updateLetterMutation.mutate(
          ...
          {
            onSuccess: () => {
              showNotification("Letter updated successfully");
              closeForm();
              setPagination((prev) => ({
                ...prev,
                letters: { ...prev.letters, page: 1 },
              }));
            },
            onError: (error) =>
              showNotification(
                error.message || "Failed to update letter",
                "error",
              ),
          },
        );
        ...
        createLetterMutation.mutate(d, {
          onSuccess: () => {
            showNotification("Letter created successfully");
            closeForm();
            setPagination((prev) => ({
              ...prev,
              letters: { ...prev.letters, page: 1 },
          ...
          onError: (error) =>
            showNotification(
              error.message || "Failed to create letter",
              "error",
            ),
        });
      }
  ...
  const subcategoriesData_paginated = getPaginatedData(
    subcategories,
    "subcategories",
  );
    ...
    return (
      ...
      >
        <div style={{ textAlign: "center" }}>
          <div
            className="w-14 h-14 rounded-full bg-sky-100 flex items-center justify-center"
  ...
  const errorMessage = fetchErrors.length
    ? fetchErrors.map((e) => e?.message || String(e)).join(" • ")
    : null;
              ...
              <>
                ...
                <div style={{ position: "relative" }}>
                  ...
                  {editingItem && (
                    ...
                    >
                      Current password is hidden for security. Enter a new
              ...
              <>
                ...
                <div>
                  ...
                  <input
                    type="text"
                    placeholder="e.g., A_a"
                    value={formData.full_code || ""}
                    onChange={(e) =>
                      setFormData({ ...formData, full_code: e.target.value })
                    }
                    style={inputCls}
                  />
                </div>
            ...
            <div style={{ display: "flex", gap: 12, paddingTop: 8 }}>
              <button
                ...
                style={{
                  ...
                  fontFamily: "system-ui",
                  letterSpacing: 0.3,
                  boxShadow: `0 8px 24px ${ac.from}40`,
                }}
              >
        ...
        <div style={{ padding: 48, textAlign: "center" }}>
          <div
            style={{
              ...
              borderTop: `3px solid ${accentColor.from}`,
              borderRadius: "50%",
          ...
          />
          <p
            style={{ color: "#94a3b8", fontFamily: "system-ui", fontSize: 14 }}
          >
            Loading…
          </p>
        </div>
      ...
      >
        ...
        <aside
          style={{
            width: 260,
            background:
              "linear-gradient(180deg,#0f0c29 0%,#1e1b4b 50%,#0f0c29 100%)",
            display: "flex",
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    cursor: "pointer",
                    background: active
                      ? `linear-gradient(135deg,${ac.from}22,${ac.to}22)`
                      : "transparent",
                    transition: "background 0.15s",
                    textAlign: "left",
                    borderLeft: active
                ...
                >
                  <item.icon
                    size={18}
                    color={active ? ac.from : "rgba(255,255,255,0.4)"}
                  />
                  <span
                    style={{
                      fontSize: 14,
          ...
          >
            ...
            >
              ...
              <div style={{ overflow: "hidden", flex: 1 }}>
                ...
                <div
                  style={{ fontSize: 11, color: "#818cf8", fontWeight: 500 }}
                >
                  Administrator
                </div>
              </div>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
              <div
                style={{
                  ...
                  fontSize: 13,
                  fontWeight: 700,
                  boxShadow: `0 4px 12px ${accentColor.from}50`,
                  display: "flex",
                  alignItems: "center",
                  gap: 6,
                }}
            ...
            <div style={{ maxWidth: 1100, margin: "0 auto" }}>
                        ...
                        >
                          <div
                            style={{
                              ...
                              alignItems: "center",
                              justifyContent: "center",
                              boxShadow: `0 8px 20px ${s.from}40`,
                            }}
                          >
                    ...
                    >
                      ...
                      {[
                        ...
                        },
                        {
                          ...
                          max: Math.max(subcategories.length, 1),
                          color: "#10b981",
                        },
                        {
                          label: "Topics",
                          ...
                          >
                            <div
                              style={{
                                ...
                                justifyContent: "center",
                                flexShrink: 0,
                                boxShadow: `0 4px 12px ${a.from}40`,
                              }}
                            >
              ...
              {activeTab === "users" && (
                <div style={{ animation: "fadeIn 0.3s ease" }}>
                  <PageHeader
                    ...
                    count={usersData_paginated.totalItems}
                    action={
                      <AddBtn
                        label="User"
                    ...
                    rows={usersData_paginated.items.map((u) => (
                      ...
                      >
                        <td style={tdStyle}>
                          ...
                          >
                            <div
                              style={{ ...avatarStyle("#ec4899", "#a855f7") }}
                            >
                              <span
                                style={{
                                  color: "#fff",
                        ...
                        <td style={tdStyle}>
                          <span
                            style={badgeStyle(
                              u.role === "admin" ? "#ede9fe" : "#eff6ff",
                              u.role === "admin" ? "#7c3aed" : "#1d4ed8",
                            )}
                          >
                            {u.role}
                          </span>
              ...
              {activeTab === "categories" && (
                <div style={{ animation: "fadeIn 0.3s ease" }}>
                  <PageHeader
                    ...
                    count={categoriesData_paginated.totalItems}
                    action={
                      <AddBtn
                        label="Category"
                        onClick={() => openForm("category")}
                        ac={ACCENT.categories}
                      />
                    }
                  />
                  <Table
                      ...
                      >
                        <td style={tdStyle}>
                          ...
                          >
                            <div
                              style={avatarStyle(
                                ACCENT.categories.from,
                                ACCENT.categories.to,
                              )}
                            >
              ...
              {activeTab === "subcategories" && (
                <div style={{ animation: "fadeIn 0.3s ease" }}>
                  <PageHeader
                    title="Subcategories"
                    subtitle="Manage content subcategories"
                    count={subcategoriesData_paginated.totalItems}
                    action={
                      <AddBtn
                        label="Subcategory"
                        onClick={() => openForm("subcategory")}
                        ac={ACCENT.subcategories}
                      />
                    }
                  />
                  <Table
                      ...
                      >
                        <td style={tdStyle}>
                          ...
                          >
                            <div
                              style={avatarStyle(
                                ACCENT.subcategories.from,
                                ACCENT.subcategories.to,
                              )}
                            >
              ...
              {activeTab === "topics" && (
                <div style={{ animation: "fadeIn 0.3s ease" }}>
                  <PageHeader
                    title="Topics"
                    subtitle="Manage content topics"
                    count={topicsData_paginated.totalItems}
                    action={
                      <AddBtn
                        label="Topic"
              ...
              {activeTab === "letters" && (
                <div style={{ animation: "fadeIn 0.3s ease" }}>
                  <PageHeader
                    title="Letters"
                    subtitle="Manage all wellness letters"
                    count={lettersData_paginated.totalItems}
                    action={
                      <AddBtn
                        label="Letter"
  ...
  return (
    <button
      ...
      style={{
        ...
        fontWeight: 700,
        cursor: "pointer",
        boxShadow: `0 6px 20px ${ac.from}50`,
        transition: "transform 0.15s,box-shadow 0.15s",
        whiteSpace: "nowrap",
      }}
      onMouseEnter={(e) => {
        e.currentTarget.style.transform = "scale(1.03)";
        e.currentTarget.style.boxShadow = `0 10px 28px ${ac.from}60`;
      }}
      onMouseLeave={(e) => {
        e.currentTarget.style.transform = "";
        e.currentTarget.style.boxShadow = `0 6px 20px ${ac.from}50`;
      }}
    >
      <Plus size={16} />
      Add {label}
