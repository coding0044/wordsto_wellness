...
function ResetPasswordForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch(ApiRoutes.auth.resetPassword(resetToken as string), {
        method: 'PUT',
      ...
      <div className="min-h-screen bg-gradient-to-br from-cyan-50 via-sky-50 to-teal-50 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-md bg-white rounded-3xl shadow-lg p-8">
          <div className="text-center">
            ...
            <Link href={Routes.auth.forgotPassword} className="inline-block px-6 py-2 bg-sky-500 hover:bg-sky-600 text-white rounded-xl font-semibold transition">
              Request New Link
            </Link>
          </div>
        </div>
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-3xl shadow-lg p-8">
          ...
          <div className="mt-6 text-center">
            <Link href={Routes.auth.login} className="text-sm text-sky-600 hover:text-sky-700 font-medium">
              Back to Login
            </Link>
          </div>
        </div>
